...
model_path = "../models/efficientdet_d2_no_preprocess.onnx"
...
sub = np.array([0.48500001430511475, 0.4560000002384186, 0.4059999883174896], dtype="float32")

mul = np.array([4.366812229156494, 4.464285373687744, 4.44444465637207], dtype="float32")

inp = (input_data.astype(dtype) * 0.00392157 - sub) * mul
input_dict = {iname: tvm.nd.array(inp.astype("float32"))}

onnx_input_dict = {iname: input_dict[iname]}
